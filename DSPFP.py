...
def DSPFP(A, B, C=0.0, D=0.0, lam=0.0, alpha=0.5, threshold1=1.0e-5,
    ...
    for Large Graph Matching' by Yao Lu, Kaizhu Huang, Cheng-Lin Liu.
    ...
    # Initialize X and Y if necessary:
    if X is None:
...
def DSPFP_faster(A, B, C=0.0, D=0.0, lam=0.0, alpha=0.5, threshold1=1.0e-6,
...
def DSPFP_faster_K(A, B, K=0.0, lam=0.5, alpha=0.5, threshold1=1.0e-6,
                 threshold2=1.0e-6, X=None, Y=None, verbose=True,
                 max_iter1=100, max_iter2=100):
    """A faster and more efficient implementation of DSPFP().
    """
